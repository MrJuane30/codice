...
@endsection
@section('content')
    <h1 class="text-center">Crear un nuevo archivo</h1>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">{{ __('Crear archivo') }}</div>
    
                    <div class="card-body">
                        <form method="POST" action="{{route('repositorio.store')}}" enctype="multipart/form-data" novalidate>
                            @csrf
                            ...
                            <div class="form-group row" style="hidden">
                                ...
                                <div id="documentoImagen" style="display: none">
                                    <div class="form-group row">
                                ...
                                <div id="documentoDocumento" style="display: none">
                                    <div class="form-group row">
                            ...
                            <div id="documentoVideo" style="display: none">
                                <div class="form-group row">
