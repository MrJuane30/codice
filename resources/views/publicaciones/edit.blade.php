...
@section('content')
<h2 class="text-center mb-5">Editar publicación: {{$publicacion->titulo}}</h2>
<div class="row justify-content-center mt-5">
    <div class="col-md-8">
    <form method="post" action="{{route('publicacion.update', ['publicacion'=>$publicacion->id])}}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('put')
            ...
            <div class="form-group">
                ...
                <option value="{{$categoria->id}}" {{$publicacion->categoria_id == $categoria->id ? 'selected' : ''}}>{{$categoria->nombre}}</option>
                @endforeach
                <!--termino for each -->
                </select>
                @error('categoria')
            ...
            <div class="form-group mt-3">
                ...
                <input type="hidden" id="descripcion" name="descripcion" value="{{$publicacion->descripcion}}">
            ...
            <div class="form-group mt-3">
                ...
                <input type="hidden" id="contenido" name="contenido" value="{{$publicacion->contenido}}">
            ...
            <div class="form-group mt-3">
                ...
                <input type="hidden" id="fuentes" name="fuentes" value="{{$publicacion->fuentes}}">
            ...
            <div class="form-group mt-3">
                ...
                <div class="mt-4">
                    ...
                    <img src="/storage/{{$publicacion->imagen}}" style="width: 30%">
                </div>
                @error('imagen')
                <span class="invalid-feedback d-block" role="alert">
                    <strong>{{$message}}</strong>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-dark">
                    {{ __('Editar publicación ') }} <i class="fas fa-edit"></i>
                </button>  
                <a href="{{route('publicacion.index')}}" class="btn btn-dark offset-md-6">Regresar</a>
            </div>
        </form>
    </div>
</div>
