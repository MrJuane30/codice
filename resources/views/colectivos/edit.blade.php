...
@section('content')
    ...
    <div class="container">
        <div class="mt-5 row justify-content-center">
            <form  id="registroColectivo" class="col-md-12 col-xs-12" action="{{route('colectivo.update', ['colectivo' => $colectivo->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <fieldset class="border p-4">
                    ...
                    <div class="form-group">
                        ...
                        <input id="nombre" type="text"
                            ...
                            placeholder="Nombre del colectivo" value="{{$colectivo->nombre}}"
                            name="nombre">
                        @error('nombre')
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <img class="w-25 p-3 mt-10"src="/storage/{{$colectivo->imagen_principal}}" alt="">
                    </div>
                </fieldset>
                <fieldset class="border p-4">
                    ...
                    <div class="form-group">
                        ...
                        <input id="pagina_web" type="text"
                            ...
                            placeholder="Página del colectivo" value="{{ $colectivo->pagina_web}}"
                            name="pagina_web">
                        @error('pagina_web')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input id="hashtag" type="text"
                            ...
                            placeholder="Hashtag o lema del colectivo" value="{{ $colectivo->hashtag}}"
                            name="hashtag">
                        @error('hashtag')
                            <div class="invalid-feedback">
                                {{ $message }}
                ...
                <fieldset class="border p-4">
                    ...
                    <div class="form-group">
                        ...
                        <input id="direccion" name="direccion" type="text"
                            ...
                            placeholder="Dirección" value="{{ $colectivo->direccion }}">
                        @error('direccion')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="colonia" name="colonia" type="text"
                            ...
                            placeholder="Colonia" value="{{ $colectivo->colonia }}">
                        @error('colonia')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <input type="hidden" id="lat" name="lat" value="{{ $colectivo->lat }}">
                    <input type="hidden" id="lng" name="lng" value="{{ $colectivo->lng }}">
                </fieldset>
                <fieldset class="border p-4">
                    <legend class="text-primary">Descripcion del colectivo</legend>
                <div class="form-group">
                    <label for="descripcion" class="text-secondary">Descripción</label>
                    <textarea class="form-control @error('descripcion') is-invalid @enderror"  name="descripcion">{{ $colectivo->descripcion }}</textarea>
                         @error('descripcion')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                 ...
                 <div class="form-group row mb-0 justify-content-center">
                    <div class="col-md-6 offset-md-4">
                        <button type="submit" class="btn btn-dark">
                            {{ __('Editar colectivo') }} <i class="fas fa-user-edit"></i>
                        </button>
