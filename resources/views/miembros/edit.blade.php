...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">{{ __('Editar miembro') }}</div>
    
                    <div class="card-body">
                        <form method="POST" action="{{route('miembro.update', ['miembro'=>$miembro->id])}}"  enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" value="{{$miembro->nombre}}" required autocomplete="nombre" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="apellidos" type="text" class="form-control @error('apellidos') is-invalid @enderror" name="apellidos" value="{{ $miembro->apellidos }}" required autocomplete="apellidos" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="intereses" name="intereses" value="{{$miembro->intereses}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="curriculum" name="curriculum" value="{{$miembro->curriculum}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="gustos" name="gustos" value="{{$miembro->gustos}}">
                            ...
                            <div class="form-group row">
                                <label for="imagen" class="col-md-4 col-form-label text-md-right">{{ __('Imagen') }}</label>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <img src="/storage/{{$miembro->imagen}}" style="width: 30%">
                                    </div>
                            </div>
                            <div class="form-group row mb-0 justify-content-center">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-dark">
                                        {{ __('Editar ') }} <i class="fas fa-user-edit"></i>
                                    </button>
