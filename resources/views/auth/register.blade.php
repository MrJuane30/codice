    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card formulario">
                <div class="card-header text-center titulo">{{ __('Registro') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right text-light">{{ __('Nombre') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="apellidos" class="col-md-4 col-form-label text-md-right text-light">{{ __('Apellidos') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right text-light">{{ __('Confirma tu contraseña') }}</label>
                        ...
                        <div class="form-group row mb-0 justify-content-center">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-dark">
                                    {{ __('Registrarme ') }} <i class="fas fa-user-plus"></i>
                                </button>
                            </div>
                        </div>
                    </form>
